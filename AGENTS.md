# AGENTS.md - LazyClip project context (read this first)

> Multiple agents/sessions work on this repo (Codex). Keep this file updated.
> Last updated: building auth + dashboard + pricing + Dodo + waitlist→users migration.
