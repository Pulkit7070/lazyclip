...
| 0:15 | Telegram chat with the bot | "This is reely. It's an AI agent. Watch - I'll just talk to it." |
| 0:20 | **WOW - generate.** Type: *"make me a reel on why UPI beat credit cards"* | "I don't give it footage. I give it an idea. it brainstorms a viral angle, writes the script, voices it, and cuts a vertical reel." |
...
| 1:55 | Tap Pro → watermark gone (pre-arranged) | "That's the whole loop: free reels spread it, ₹99 removes the mark. Codex wrote it, ffmpeg does the cutting." |
...
- **"How is this an agent and not just ffmpeg?"** → The agent runtime is what users talk to - the gateway,
  the skill routing, and the content generation (brainstorm/script/captions). We also built it with Codex.
